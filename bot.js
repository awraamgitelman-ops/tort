...
export function initBot() {
 ...
 bot.answerCallbackQuery(query.id, { text: ' Пост не знайдено або вже видалено.' });
 }
 }
 });
