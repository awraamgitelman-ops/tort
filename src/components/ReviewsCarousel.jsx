...
const REVIEWS = [
  ...
  },
  {
    ...
    text: 'Добрий вечір! Дякуємо за тортик. Він приємно вразив іменинника своїм виглядом і за смаком також просто бездоганний!'
  },
  {
    id: 4,
    name: 'Анастасія Кравченко',
    text: 'Добрий вечір! Наше свято трошки затягнулося, не мала нагоди одразу Вам подякувати за надзвичайно смачний тортик! Просто відпад, ще раз щиро дякую, неймовірна смакота. У Вас золоті ручки!'
  },
  {
    id: 5,
  ...
  },
  {
    ...
    text: 'Доброго ранку! Тортик ну дуже смачний! Гості високо оцінили, усі смакували ніжний білий крем і намагались зрозуміти, що ж то за божественний смак такий. Велике Вам дякую!'
  }
];
